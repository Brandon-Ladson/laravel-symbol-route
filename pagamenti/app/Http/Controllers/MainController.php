...
class MainController extends Controller
{
  ...
  // funzione per far tornare tutti i pagamenti
  public function tornaPagamentiPage() {
  ...
  // funzione per far tornare solo pagamenti pending
  public function tornaPagamentiPending() {
    ...
    // ciclo per filtrare pagamenti pending
    foreach ($pagamenti as $pagamento) {

      $stato = $pagamento['status'];

      // se stato è uguale a pending pusho il pagamento dentro pagamentiFilter
      if ($stato == 'pending') {

        $pagamentiFilter[] = $pagamento;

      }

    }

    // rendo l'arrya di partenza uguale a quello con i pagemnti filtrati
    $pagamenti = $pagamentiFilter;
